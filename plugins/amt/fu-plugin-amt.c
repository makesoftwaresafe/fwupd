...
fu_plugin_amt_create_device(FuPlugin *plugin, FuProgress *progress, GError **error)
{
	...
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 50, "create-context");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 33, "get-version");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 1, "verify-code-version");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 17, "add-device");
