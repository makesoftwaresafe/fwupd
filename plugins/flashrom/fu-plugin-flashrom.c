...
fu_plugin_flashrom_startup(FuPlugin *plugin, FuProgress *progress, GError **error)
{
	...
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 5, "find-guid");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 90, "init");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 5, "probe");
