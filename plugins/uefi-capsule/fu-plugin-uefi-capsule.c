...
fu_plugin_uefi_capsule_coldplug(FuPlugin *plugin, FuProgress *progress, GError **error)
{
	...
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 63, "find-esp");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 1, "check-cod");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 8, "check-bitlocker");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 1, "coldplug");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 26, "add-devices");
	fu_progress_add_step_full(progress, FWUPD_STATUS_LOADING, 1, "setup-bgrt");
